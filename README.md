# Projeto Quiz
Um pequeno projeto de quiz desenvolvido para praticar HTML.

## 📚 Sobre o projeto
Este projeto faz parte dos meus estudos de desenvolvimento web.
A ideia é criar um quiz simples com perguntas e respostas utilizando HTML.

## 🚀 Tecnologias utilizadas
- HTML5 (por enquanto)

## 🎯 Objetivo
Praticar conceitos básicos de HTML como:
- formulários
- inputs
- estrutura de página
...
## 📸 Demonstração
![Página inicial](https://github.com/user-attachments/assets/236624bd-2622-4a91-b260-778dac073190)
![Perguntas do 1 ao 6](https://github.com/user-attachments/assets/414d461f-72f1-4817-a1af-243bc6f1b30c)
